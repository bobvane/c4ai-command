...
const UUID = process.env.UUID || 'bf99c7e3-333b-4352-a0b8-5242ff790154'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'bobvane';            // 获取节点的订阅路径
const NAME = process.env.NAME || '美国US-huggingface';                       // 节点名称
